...
/*         $widget_ops = array(
    ...
    public function widget($args, $instance){
        ...
        if(get_option('agsml_facebook')){
            $social_list .= '<li class="facebook"><a href="' . get_option('agsml_facebook') . '"> '. __('Friend us on FB', 'agsml') .'</a></li>';
        }
    ...
    public function update($new_instance, $old_instance){
        //save widget options once settings change
    ...
    public function form($instance){
        //form to display the widget settings
